...
def check_game_over(game_over):
    ...
    if snake_pos[0][0] < 0 or snake_pos[0][0] > (screen_width - cell_size) or snake_pos[0][1] < 0 or snake_pos[0][1] > (screen_height - cell_size):
        game_over = True
...
def draw_game_over():
    ...
    #pygame.draw.rect(screen, red, (int(screen_width/2) - 80, int(screen_height/2) - 60, 160, 50))
    screen.blit(over_img, (int(screen_width/2) - 80, int(screen_height/2) - 50))
